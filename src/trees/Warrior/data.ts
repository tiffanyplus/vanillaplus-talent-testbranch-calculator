  ...
  Arms: {
    ...
    talents: {
      ...
      "Deep Wounds": {
        ...
        description: talentText`Deep Wounds des`,
      },
      "Poleaxe Specialization": {
        ...
        maxRank: 5,
        reqPoints: 15,
        description: talentText`Poleaxe description`,
      },
      "Mace Specialization": {
      ...
      "Two-Handed Weapong Specialization": {
        ...
        maxRank: 5,
        reqPoints: 20,
        description: talentText`2h description.`,
      },
      "Maim": {
        name: "Maim",
        pos: "e4",
      ...
      "Improved Mortal Strike": {
        ...
        description: talentText`Improved Mortal Strike`,
      },
    },
  },
  Fury: {
    ...
    talents: {
      "Combat Endurance": {
        ...
        maxRank: 5,
        reqPoints: 0,
        description: talentText`Combat Endurance`
      },
      "Booming Voice": {
        name: "Booming Voice",
        pos: "a2",
      ...
      "Inner Rage": {
        ...
        maxRank: 2,
        reqPoints: 20,
        description: talentText`Inner Rage`,
      },
      "Death Wish": {
        name: "Death Wish",
        pos: "e2",
      ...
      "Improved Bloodthirst": {
        ...
        prereq: "Bloodthirst",
        arrows: [{ dir: "right", from: "g2", to: "g3"}],
        description: talentText`Improved Bloodlust`,
      },
    },
  },
  Protection: {
    ...
    talents: {
      ...
      "Shield Mastery": {
        ...
        maxRank: 3,
        reqPoints: 10,
        description: talentText`Shield Mastery`,
      },
      "Blade Mail": {
        name: "Blade Mail",
        pos: "c3",
        ...
        maxRank: 3,
        reqPoints: 10,
        description: talentText`Blade Mail`,
      },
      "Concussion Blow": {
      ...
      "Shield Toss": {
        ...
        maxRank: 1,
        reqPoints: 20,
        description: talentText`Shield Toss`,
      },
      "Training and Discipline": {
        ...
        maxRank: 3,
        reqPoints: 20,
        description: talentText`Training and Discipline`,
      },
      ...
      "Vitality": {
        ...
        maxRank: 5,
        reqPoints: 25,
        description: talentText`Vitality`,
      },
      "Butterfly Style": {
        ...
        maxRank: 5,
        reqPoints: 25,
        description: talentText`Butterfly Style`,
      },
      ...
      "Constitution": {
        ...
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`Constitution`,
      },
    },
  },
};
